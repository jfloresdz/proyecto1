...
module.exports.contrasenaProfesor = function (req, res) {
...
module.exports.contrasenaEstudiante = function (req, res) {
    let correo =req.body.correo;
    let contrasena = req.body.contrasena;
    estudianteModel.findByIdAndUpdate(req.body._id, { $set:req.body },
        function (err, user) {
            if (err) {
                res.json({ success: false, msj: 'No se ha actualizado: ' + handleError(err) });
            } else {
